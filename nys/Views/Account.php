    ...
    <?php if ($allowPasswordChange) : ?>
        <div class="well">        
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="password" class="form-control" name="oldpassword" id="oldpassword" placeholder="<?php echo $GLOBALS["Language"]->Password; ?>">
                    <div class="text-success" id="oldpassword_strength" style="font-weight:bold;padding-top: 12px;"></div>
                </div>
            </div>
            <div class="form-group">
                <label for="inputPassword" class="control-label col-xs-2">
                ...
                <div class="col-xs-10">
                    ...
                    <div class="text-success" id="password_strength" style="font-weight:bold;padding-top: 12px;"></div>
                </div>
            </div>
            <div class="form-group">
                <label for="inputPassword" class="control-label col-xs-2">
...
<script type="text/javascript">
    ...
    $(document).ready(function($) {
        var hchy = {
            '0': ['text-danger', '<?php echo $GLOBALS["Language"]->Password_Insecure; ?>'],
            '10': ['text-danger', '<?php echo $GLOBALS["Language"]->Password_VeryWeak; ?>'],
            '20': ['text-warning', '<?php echo $GLOBALS["Language"]->Password_Weak; ?>'],
            '30': ['text-warning', '<?php echo $GLOBALS["Language"]->Password_StillWeak; ?>'],
            '40': ['text-success', '<?php echo $GLOBALS["Language"]->Password_Okay; ?>'],
            '50': ['text-success', '<?php echo $GLOBALS["Language"]->Password_Strong; ?>']
        };
        $("input[name='oldpassword']").strengthMeter('text', {
            container: $("#oldpassword_strength"),
            hierarchy: hchy
        });
        $("input[name='password']").strengthMeter('text', {
