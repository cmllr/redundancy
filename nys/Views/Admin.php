				...
				<div class="col-xs-10">
					<select class='form-control' id='group' name='group'>
						...
						<?php foreach($groups as $key=>$value): ?>			  
							<option value="<?php echo $value->Id;?>" <?php echo ($user->Role->Description == $value->Description) ? "selected": "" ;?>><?php echo $value->Description; ?></option>				   
						<?php endforeach; ?>	
					</select>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(window).load(function(){
		...
		else if (window.location.href.indexOf("?admin&t=register") != -1)
