...
<div class="navbar-header">
	...
	<a class="navbar-brand" href="index.php"><?php echo $GLOBALS["config"]["Program_Name_ALT"];?></a>
</div>
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
	<ul class="nav navbar-nav">
		...
		<li>
			<a href="index.php?module=list"><?php echo $GLOBALS["Program_Language"]["Files"];?></a>
		</li>
		<li>
			<a href="index.php?module=changes"><?php echo $GLOBALS["Program_Language"]["changes"];?></a>
		</li>
		<li>
				<a href="index.php?module=search"><?php echo $GLOBALS["Program_Language"]["Search"];?></a>
		</li>
		<li>
			<a href="index.php?module=upload"><?php echo $GLOBALS["Program_Language"]["Upload"];?></a>
		</li>
		<li>
			<a href="index.php?module=createdir"><?php echo $GLOBALS["Program_Language"]["New_Directory"];?></a>
		</li>
		<li>
			<a href="index.php?module=account"><?php echo $GLOBALS["Program_Language"]["My_Account"];?></a>
		</li>
		<li>
			<a href="index.php?module=info">Info</a>
		</li>
		<li>
			<a href="index.php?module=logout"><?php echo $GLOBALS["Program_Language"]["Exit"];?></a>
		</li>
		
	</ul>
	<form method="POST" action="index.php?module=list" class="navbar-form navbar-left" role="search">
		<div class="form-group">
			<input id = "searchquery" name = "searchquery" type="text" class="form-control" placeholder="Search">
		</div>
...
<div class="col-lg-2 col-md-2 col-sm-3 hidden-xs">
	<div class="sidebar-nav-fixed" id="leftSidebar" data-spy="affix" data-offset-top="140">
		...
		<ul class="nav nav-pills nav-stacked">
			<li>
				<a href="index.php"><span class="elusive icon-home glyphIcon"></span>Start</a>
			</li>
			<li >
			...
			<li>
				<span class="label label-info">
				<?php echo fs_get_fitting_DisplayStyle(memory_get_usage());?> Memory
				</span>
			</li>			
