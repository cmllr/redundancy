...
module.exports = function(grunt) {
    ...
    grunt.registerTask('build', ['jshint', 'jade:serve', 'clean:before', 'less', 'dom_munger', 'ngtemplates', 'cssmin', 'concat', 'ngmin', 'uglify', 'copy', 'htmlmin', 'imagemin', 'clean:after']);
    grunt.registerTask('serve', ['jade:serve', 'dom_munger:read', 'jshint', 'connect', 'watch']);
    ...
    grunt.event.on('watch', function(action, filepath) {
        ...
        if (filepath.lastIndexOf('.jade') !== -1) {
            tasksToRun.push('jade:serve');
        }
